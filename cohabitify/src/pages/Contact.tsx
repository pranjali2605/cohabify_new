      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Have questions about CoHabitify? Need help getting started? We're here to help you create better living experiences.
          </p>
        </div>
      </section>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@cohabitify.com" className="text-blue-600 hover:text-blue-700 font-medium">
                      support@cohabitify.com
                    </a>
                  </div>
                </div>
