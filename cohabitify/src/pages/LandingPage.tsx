        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-900">CoHabitify</span>
            </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            CoHabitify combines habit tracking, roommate coordination, and anonymous emotional 
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Join thousands of users who have transformed their living experience with CoHabitify.
                </p>
                <Link 
                  to="/register" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-8 rounded-2xl">
              ...
              <p className="text-gray-700 mb-6">
                "CoHabitify completely changed how my roommates and I manage our apartment. The habit tracker keeps us all accountable, and the anonymous sharing feature helped us address issues we were too shy to bring up before."
              </p>
            ...
            <div className="bg-gray-50 p-8 rounded-2xl">
              ...
              <p className="text-gray-700 mb-6">
                "As someone who struggled with maintaining routines, the habit tracker in CoHabitify has been a game-changer. The mood tracking feature also helps me understand my patterns better. Highly recommend!"
              </p>
              <div className="flex items-center">
            ...
            <div className="bg-gray-50 p-8 rounded-2xl">
              ...
              <p className="text-gray-700 mb-6">
                "Living with three other people used to be chaotic. CoHabitify's roommate management tools made everything so much easier - from splitting bills to coordinating chores. We're all happier now!"
              </p>
              <div className="flex items-center">
      ...
      <section id="faq" className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Everything you need to know about CoHabitify
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">
                How does CoHabitify work?
              </h3>
              <p className="text-gray-600">
                CoHabitify is an all-in-one platform that combines four essential tools: Habit Tracker for personal growth, RoomMate for household management, SecretCircle for anonymous communication, and MoodMirror for emotional well-being. Simply create an account, invite your roommates, and start using the features that matter most to you.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">
                Can I use CoHabitify if I live alone?
              </h3>
              <p className="text-gray-600">
                Yes! While CoHabitify is designed for shared living, many features like Habit Tracker and MoodMirror work perfectly for individual use. You can always invite roommates later or use it to prepare for future shared living situations.
              </p>
            </div>

            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">
                How much does CoHabitify cost?
              </h3>
              <p className="text-gray-600">
                CoHabitify offers a free tier with basic features for up to 3 roommates. Our Premium plan ($9.99/month per household) includes unlimited roommates, advanced analytics, custom habit categories, and priority support. We also offer a 30-day free trial of Premium features.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                CoHabitify is currently available as a responsive web application that works great on all devices. Native iOS and Android apps are in development and will be available in Q2 2024. You can add our web app to your home screen for a native-like experience.
              </p>
            </div>
          ...
          <div className="text-center mt-12">
            ...
            <a href="mailto:support@cohabitify.com" className="text-blue-600 hover:text-blue-700 font-semibold">
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">CoHabitify</span>
              </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 CoHabitify. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
